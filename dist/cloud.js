...
render=function(){oldRender();const demo=$('.demo');if(demo)demo.innerHTML='<span>'+esc(siteText('banner'))+'</span><span>'+esc(siteText('bannerBadge'))+'</span>';const edit=$('#edit-site');if(edit){edit.textContent=siteText('adminTitle');edit.onclick=()=>{captureDraft();location.hash='admin';renderAdmin();};}cloudBar();if(typeof enhanceWarehouse==='function')enhanceWarehouse();};
